...
DECODER_DIMS = {"logo": args.LOGO_DEC_DIMS}
ENCODER_DIMS = {"design": args.DES_ENC_DIMS}
K = args.K
...
givens.columns = ["K", "logo_dec", "des_enc", "batches", "iters", "adam_lr", "annealing_batches", "num_particles", "center_bp", "weight_decay","folds"]
